...
#!/bin/bash
set -o xtrace
/etc/eks/bootstrap.sh innovatemart-eks-cluster --apiserver-endpoint https://86B9074BC596786B8F1006D00C653E1C.gr7.us-east-1.eks.amazonaws.com --b64-cluster-ca LS0tLS1CRUdJTiBDRVJUSUZJQ0FURS0tLS0tC[...]
EOT
        )
      }
