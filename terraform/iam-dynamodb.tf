...
# IAM Role for Carts Service to access DynamoDB - COMMENTED OUT (RDS module disabled)
# Uncomment when RDS module is re-enabled
...
#       Condition = {
#         StringEquals = {
#           "${replace(module.eks.cluster_oidc_issuer_url, "https://", "")}:sub" = "system:serviceaccount:retail-store:carts"
...
# IAM Policy for DynamoDB access - COMMENTED OUT (RDS module disabled)
